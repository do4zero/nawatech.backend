    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto">
            ...
            <div>
                ...
                <?php endif; ?> <?php if($isOpen): ?> <?php echo $__env->make('livewire.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php endif; ?>
                    ...
                    <div class="bg-white rounded-md shadow-lg mb-4">
                        <div class="p-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <div>Stok : <?php echo e($product->stok); ?></div>
                            </div>
                        </div>
                        <div
                        ...
                        <div>
                            <div class="flex rounded-md shadow-sm" role="group">
                                <button
                                    ...
                                    class="flex-1 px-4 py-1.5 text-sm font-medium text-white bg-slate-600 hover:bg-slate-900 hover:text-white focus:z-10 focus:text-white dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600"
                                >
                                    <i
                                ...
                                <button
                                    ...
                                    class="flex-1 px-4 py-1.5 text-sm font-medium text-white bg-red-600 hover:bg-red-900 hover:text-white focus:z-10 focus:text-white dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600"
                                >
                                    <i
...
<?php /**PATH /home/midpc/Documents/Nawatech/backend/resources/views/livewire/products.blade.php ENDPATH**/ ?>