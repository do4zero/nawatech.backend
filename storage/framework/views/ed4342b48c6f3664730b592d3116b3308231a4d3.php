...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <?php if(!empty($image)): ?>
                        <?php if(preg_match("#\.(jpg|jpeg|gif|png)$# i",$image)): ?>
                            <img src="<?php echo e(asset($image)); ?>" class="image"/>
                        <?php else: ?>
                            <img src="<?php echo e($image->temporaryUrl()); ?>" class="image"/>
                        <?php endif; ?>
                        <br/>
                    <?php endif; ?>
...
<?php /**PATH /home/midpc/Documents/Nawatech/backend/resources/views/livewire/create.blade.php ENDPATH**/ ?>